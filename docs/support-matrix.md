...
| 각주/미주 | Edit·Create·**Render-unverified** | `add_footnote`·`add_endnote`; M6 읽기 경로에서 note 노출. **렌더 실측(2026-08-01): 생성 각주의 참조 번호·각주부가 실한컴 PDF export에 표시되지 않음** — 계약 리버스 전까지 honest-defer(문서는 정상 개봉·보존) |
